...
EXPECT_CERT="$(hash_file "$STATE/certs/cert.pem")"
EXPECT_KEY="$(hash_file "$STATE/certs/key.pem")"
...
assert_eq "certs/cert.pem"            "$EXPECT_CERT"         "$(hash_file "$DEST/certs/cert.pem")"
assert_eq "certs/key.pem"             "$EXPECT_KEY"          "$(hash_file "$DEST/certs/key.pem")"
