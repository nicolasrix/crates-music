...
Upstream path:   preprocessing/audio/MusicHubert.py
Upstream commit: 9016d2b0c8d12d1aa79c2e0ab201e6822bdc83a8
License:         MIT (see ./LICENSES/MIT-LICENSE)

Local modifications:
- 2026-05-30: Changed `from configuration_musichubert import MusicHubertConfig`
  to `from .musichubert_config import MusicHubertConfig` (relative import for
  the vendored package layout). No other code changes.
"""
import argparse
import json
import os
